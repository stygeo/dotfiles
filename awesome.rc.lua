...
-- {{{ Tags
tags = {
	names = { "main", "dev", "work", "net", "mail", "etc", "epix", "@", "*" },
	layout = { layouts[1], layouts[2], layouts[11], layouts[1], layouts[5], layouts[6], layouts[9], layouts[3], layouts[7] }
}
...
main_menu = awful.menu({ items = { { "awsm", myawesomemenu, beautiful.awesome_icon },
...
separator.text = " | "
-- RAM widget
ramwidget = awful.widget.progressbar({ align="right" })
ramwidget:set_width(15)
ramwidget:set_height(30)
ramwidget:set_vertical(true)
ramwidget:set_background_color('#494B4F')
ramwidget:set_color('#AECF96')
ramwidget:set_gradient_colors({ '#FF5656', '#88A175', '#AECF96' })

-- Tooltip
memwidget_t = awful.tooltip({ objects = { ramwidget.widget},})
